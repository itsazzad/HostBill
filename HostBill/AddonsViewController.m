...
- (void)viewDidLoad
{
    ...
    self.string1 = [NSString stringWithFormat:@"%@&call=getAddons", string];
    NSLog(@"%@",string1);
}
...
-(void)getData
{
    ...
    if (jsonData) {
        ...
        /*
         ...
         "id": "26",
         "products": "",
         "name": "VPS.NET: Snapshot Backup",
         "description": "Allows to enable Snapshot Backups",
         "visible": "1",
         "unique": "1",
         "taxable": "0",
         "system": "1",
         ...
         "autosetup": "0",
         "sort_order": "-18",
         "module": "class.vpsnet_snapshot.php",
         "parentactive": "1",
         "modulename": "VPS.NET: Snapshot Backup"
         },
         */
        
        _tempobject = [jsonObjects valueForKey:@"addons"];
        NSLog (@">>>%@ ",_tempobject);
...
{
    UITableViewCell *cell = [self.tableView dequeueReusableCellWithIdentifier:@"Addons" forIndexPath:indexPath];
