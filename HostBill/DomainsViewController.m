...
- (void)viewDidLoad
{
    ...
    self.string1 = [NSString stringWithFormat:@"%@&call=getDomains", string];
    NSLog(@"%@",string1);
}
...
-(void)getData
{
    ...
    if (jsonData) {
        ...
        _tempobject = [jsonObjects valueForKey:@"domains"];
        NSLog (@"%@ ",_tempobject);
...
{
    UITableViewCell *cell = [self.tableView dequeueReusableCellWithIdentifier:@"Domains" forIndexPath:indexPath];
