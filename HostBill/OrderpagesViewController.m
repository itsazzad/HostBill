...
#import "OrderpagesViewController.h"

@interface OrderpagesViewController (){
...
@implementation OrderpagesViewController
...
- (void)viewDidLoad
{
    ...
    self.string1 = [NSString stringWithFormat:@"%@&call=getOrderPages", string];
    NSLog(@"%@",string1);
}
...
{
    UITableViewCell *cell = [self.tableView dequeueReusableCellWithIdentifier:@"Orderpages" forIndexPath:indexPath];
