...
- (void)viewDidLoad
{
    ...
    self.string1 = [NSString stringWithFormat:@"%@&call=getTransactions", string];
    NSLog(@"%@",string1);
}
...
{
    UITableViewCell *cell = [self.tableView dequeueReusableCellWithIdentifier:@"Transactions" forIndexPath:indexPath];
